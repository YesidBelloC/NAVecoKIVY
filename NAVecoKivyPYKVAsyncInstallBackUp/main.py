...
class NAVecoApp(MDApp):
    ...
    def build(self):
        ...
        LatUsr = response[0]['geometry']['location']['lat'] #48.8187902
        LngUsr = response[0]['geometry']['location']['lng'] # 2.2911665

        self.root.ids.map.lat = LatUsr
        self.root.ids.map.lon = LngUsr
